#' ---
#' title: "Muestreo y Análisis de Datos"
#' subtitle: 'Ejemplo 1'
#' output:
...
#library(knitr)
#purl("test.Rmd") # Extract R code only
#purl("test.Rmd", output = "test2.R", documentation = 2)  #Extract R code and also include documentation
